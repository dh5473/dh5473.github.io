...
<svg viewBox="0 0 480 236" style="width: 100%; height: auto; max-width: 380px;"
  ...
  <text x="20" y="68" class="q2-name">bf16</text>
  <rect x="90" y="44" width="350" height="34" rx="4" class="q2-bar16"/>
  <text x="428" y="68" class="q2-val" text-anchor="end">54GB</text>
  <text x="98" y="98" class="q2-sub">27B × 2바이트</text>
  <text x="20" y="142" class="q2-name">int4</text>
  <rect x="90" y="118" width="91" height="34" rx="4" class="q2-bar4"/>
  <text x="191" y="142" class="q2-val">14.1GB</text>
...
<svg viewBox="0 0 480 300" style="width: 100%; height: auto; max-width: 380px;"
  ...
  <text x="20" y="99" class="q3-name">INT8</text>
  <rect x="86" y="76" width="30" height="32" class="q3-cs"/><text x="101" y="99" class="q3-bs">S</text>
  <rect x="116" y="76" width="30" height="32" class="q3-cm"/><text x="131" y="99" class="q3-bm">I</text>
  <rect x="146" y="76" width="30" height="32" class="q3-cm"/><text x="161" y="99" class="q3-bm">I</text>
  <rect x="176" y="76" width="30" height="32" class="q3-cm"/><text x="191" y="99" class="q3-bm">I</text>
  <rect x="206" y="76" width="30" height="32" class="q3-cm"/><text x="221" y="99" class="q3-bm">I</text>
  <rect x="236" y="76" width="30" height="32" class="q3-cm"/><text x="251" y="99" class="q3-bm">I</text>
  <rect x="266" y="76" width="30" height="32" class="q3-cm"/><text x="281" y="99" class="q3-bm">I</text>
  <rect x="296" y="76" width="30" height="32" class="q3-cm"/><text x="311" y="99" class="q3-bm">I</text>
  <text x="460" y="98" class="q3-max">최대 ±127</text>
  <text x="20" y="130" class="q3-sub">정수, 값 사이 간격이 균일</text>
  <text x="20" y="177" class="q3-name">E4M3</text>
  <rect x="86" y="154" width="30" height="32" class="q3-cs"/><text x="101" y="177" class="q3-bs">S</text>
  <rect x="116" y="154" width="30" height="32" class="q3-ce"/><text x="131" y="177" class="q3-be">E</text>
  <rect x="146" y="154" width="30" height="32" class="q3-ce"/><text x="161" y="177" class="q3-be">E</text>
  <rect x="176" y="154" width="30" height="32" class="q3-ce"/><text x="191" y="177" class="q3-be">E</text>
  <rect x="206" y="154" width="30" height="32" class="q3-ce"/><text x="221" y="177" class="q3-be">E</text>
  <rect x="236" y="154" width="30" height="32" class="q3-cm"/><text x="251" y="177" class="q3-bm">M</text>
  <rect x="266" y="154" width="30" height="32" class="q3-cm"/><text x="281" y="177" class="q3-bm">M</text>
  <rect x="296" y="154" width="30" height="32" class="q3-cm"/><text x="311" y="177" class="q3-bm">M</text>
  <text x="460" y="176" class="q3-max">최대 ±448</text>
  <text x="20" y="208" class="q3-sub">부동소수점, 0 근처가 촘촘</text>
  <text x="20" y="255" class="q3-name">E5M2</text>
  <rect x="86" y="232" width="30" height="32" class="q3-cs"/><text x="101" y="255" class="q3-bs">S</text>
  <rect x="116" y="232" width="30" height="32" class="q3-ce"/><text x="131" y="255" class="q3-be">E</text>
  <rect x="146" y="232" width="30" height="32" class="q3-ce"/><text x="161" y="255" class="q3-be">E</text>
  <rect x="176" y="232" width="30" height="32" class="q3-ce"/><text x="191" y="255" class="q3-be">E</text>
  <rect x="206" y="232" width="30" height="32" class="q3-ce"/><text x="221" y="255" class="q3-be">E</text>
  <rect x="236" y="232" width="30" height="32" class="q3-ce"/><text x="251" y="255" class="q3-be">E</text>
  <rect x="266" y="232" width="30" height="32" class="q3-cm"/><text x="281" y="255" class="q3-bm">M</text>
  <rect x="296" y="232" width="30" height="32" class="q3-cm"/><text x="311" y="255" class="q3-bm">M</text>
  <text x="460" y="254" class="q3-max">최대 ±57344</text>
  <text x="20" y="286" class="q3-sub">지수 비트를 늘려 범위를 넓힌 형식</text>
</svg>
</div>
...
Red Hat이 Llama 3.1 계열로 50만 회 이상 평가를 돌린 연구가 이 구도를 정량적으로 확인해줍니다. 요청을 하나씩 처리하는 동기 시나리오에서는 W4A16이 가장 효율적이었고, 고배치 비동기 서빙에서는 대체로 W8A8이 최고 처리량을 냈습니다. 연구팀이 블로그에 정리한 요약 수치로는 W4A16이 단일 스트림에서 평균 2.4배, W8A8이 다중 요청 서버 시나리오에서 평균 1.8배입니다. 논문 본문은 같은 결과를 범위로 보고하는데, 8B와 70B에서 W4A16이 쿼리당 비용을 2배에서 3배 낮추고 지연을 1.5배에서 2.5배 개선했습니다. 다만 비동기에서도 W4A16이 이기는 시나리오가 있고, 두 구간이 갈리는 경계 배치 크기도 모델과 하드웨어마다 달라서 보편적인 숫자는 없습니다. 정확도는 학술 벤치마크 평균으로 99% 안팎을 회복했고 가장 어려운 평가에서도 하한이 96%였는데, 특히 FP8은 모든 규모에서 사실상 무손실이었습니다.

| 항목 | W4A16 (AWQ, GPTQ) | W8A8 (FP8, INT8) |
|---|---|---|
| **가중치 압축** | 약 3.5배 (그룹 스케일 오버헤드와 16비트로 남는 임베딩·lm_head 포함) | 약 2배 |
...
어텐션 연산까지 빨라지는지는 백엔드와 GPU 세대에 달려 있습니다. FlashAttention은 Hopper의 FA3와 Blackwell의 FA4에서만 FP8 KV를 받아들이고, 이때는 쿼리까지 FP8로 양자화해 어텐션 자체를 저정밀 도메인에서 계산합니다. 그보다 앞선 세대에서 쓰이는 FA2는 FP8 KV를 저장 형식으로도 받지 않아서, 이 조합에서는 FP8 KV를 지원하는 다른 백엔드가 선택됩니다. 그쪽에서는 FP8이 저장 형식일 뿐이고 커널 안에서 복원해 16비트로 계산합니다. 그러니 KV Cache 양자화는 "어텐션이 빨라지는 기능"이 아니라 "KV 예산이 두 배가 되는 기능"으로 이해하는 것이 안전합니다.

품질 쪽에서 신경 쓸 것은 스케일입니다. E4M3는 표현 범위가 좁아 값에 맞는 스케일이 필요한데, 기본값은 스케일 1.0이라 분포가 큰 모델에서는 outlier가 잘려나갈 수 있습니다. llm-compressor로 calibration 데이터를 흘려 K와 V의 스케일을 체크포인트에 구워두는 것이 좋습니다. 참고로 sliding window 레이어의 KV는 양자화에 상대적으로 민감하다고 알려져 있어, v0.25.1 기준으로 특정 레이어를 KV 양자화에서 제외하는 옵션(`--kv-cache-dtype-skip-layers`)도 있습니다. 이 레이어를 빼는 데는 성능 쪽 이유도 있습니다. 윈도가 유한해서 스텝당 읽는 KV가 애초에 적기 때문에, 양자화로 줄어드는 읽기가 복원 비용을 상쇄하지 못해 BF16으로 두는 편이 오히려 빠릅니다.
