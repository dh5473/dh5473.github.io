...
**응용 통계(15~18편)** — 이론이 현실과 만나는 마지막 장에서는 [EDA](/stats/eda/)로 데이터와의 첫 대면법을 다루고, [표본 추출](/stats/sampling/)로 데이터 수집의 과학을 배웠으며, [A/B 테스트](/stats/ab-testing/)에서 인과 추론을 실전에 적용했다. 그리고 이 마지막 편에서, 그 모든 도구를 잘못 사용할 때 벌어지는 일들을 직시했다.
