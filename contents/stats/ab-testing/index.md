...
<div style="text-align: center; margin: 24px 0;">
  <svg viewBox="0 0 720 400" xmlns="http://www.w3.org/2000/svg" style="max-width: 720px; width: 100%; height: auto;" role="img" aria-label="A/B 테스트 구조">
    <defs>
    ...
    <!-- user pool -->
    <rect x="280" y="16" width="160" height="40" rx="8" fill="#eff6ff" stroke="#3182f6" stroke-width="1.5"/>
    <text x="360" y="41" text-anchor="middle" font-size="14" font-weight="bold" fill="#1f2937" font-family="sans-serif">사용자 풀 (N명)</text>
    <!-- split -->
    <line x1="320" y1="56" x2="210" y2="112" stroke="#6b7280" stroke-width="1.3" marker-end="url(#arrow-ab)"/>
    <line x1="400" y1="56" x2="510" y2="112" stroke="#6b7280" stroke-width="1.3" marker-end="url(#arrow-ab)"/>
    <text x="360" y="92" text-anchor="middle" font-size="12.5" fill="#6b7280" font-family="sans-serif">무작위 배정</text>
    <!-- control -->
    <rect x="120" y="116" width="170" height="56" rx="8" fill="#eff6ff" stroke="#3182f6" stroke-width="1.5"/>
    <text x="205" y="139" text-anchor="middle" font-size="13.5" font-weight="bold" fill="#1f2937" font-family="sans-serif">대조군 (A)</text>
    <text x="205" y="159" text-anchor="middle" font-size="12.5" fill="#4b5563" font-family="sans-serif">기존 UI</text>
    <!-- treatment -->
    <rect x="430" y="116" width="170" height="56" rx="8" fill="#ecfdf5" stroke="#10b981" stroke-width="1.5"/>
    <text x="515" y="139" text-anchor="middle" font-size="13.5" font-weight="bold" fill="#1f2937" font-family="sans-serif">실험군 (B)</text>
    <text x="515" y="159" text-anchor="middle" font-size="12.5" fill="#4b5563" font-family="sans-serif">새 UI</text>
    <!-- measure -->
    <line x1="205" y1="172" x2="205" y2="212" stroke="#6b7280" stroke-width="1.3" marker-end="url(#arrow-ab)"/>
    <line x1="515" y1="172" x2="515" y2="212" stroke="#6b7280" stroke-width="1.3" marker-end="url(#arrow-ab)"/>
    <rect x="120" y="216" width="170" height="56" rx="8" fill="#f9fafb" stroke="#9ca3af" stroke-width="1.5"/>
    <text x="205" y="239" text-anchor="middle" font-size="13" fill="#1f2937" font-family="sans-serif">지표 측정</text>
    <text x="205" y="259" text-anchor="middle" font-size="12.5" fill="#4b5563" font-family="sans-serif">전환율 p_A</text>
    <rect x="430" y="216" width="170" height="56" rx="8" fill="#f9fafb" stroke="#9ca3af" stroke-width="1.5"/>
    <text x="515" y="239" text-anchor="middle" font-size="13" fill="#1f2937" font-family="sans-serif">지표 측정</text>
    <text x="515" y="259" text-anchor="middle" font-size="12.5" fill="#4b5563" font-family="sans-serif">전환율 p_B</text>
    <!-- converge -->
    <line x1="205" y1="272" x2="320" y2="328" stroke="#6b7280" stroke-width="1.3" marker-end="url(#arrow-ab)"/>
    <line x1="515" y1="272" x2="400" y2="328" stroke="#6b7280" stroke-width="1.3" marker-end="url(#arrow-ab)"/>
    <rect x="220" y="332" width="280" height="52" rx="8" fill="#fffbeb" stroke="#f59e0b" stroke-width="1.5"/>
    <text x="360" y="354" text-anchor="middle" font-size="13.5" font-weight="bold" fill="#92400e" font-family="sans-serif">비교: p_B - p_A</text>
    <text x="360" y="373" text-anchor="middle" font-size="12.5" fill="#92400e" font-family="sans-serif">우연인가, 실재하는 차이인가?</text>
  </svg>
</div>
<p align="center" style="color: #888; font-size: 13px;"><em>A/B 테스트의 기본 구조. 무작위 배정으로 나눈 두 그룹의 지표를 비교한다.</em></p>
...
<div style="text-align: center; margin: 24px 0;">
  <svg viewBox="0 0 720 80" xmlns="http://www.w3.org/2000/svg" style="max-width: 720px; width: 100%; height: auto;" role="img" aria-label="실험 설계 5단계">
    <defs>
      <marker id="arrow-steps" markerWidth="8" markerHeight="8" refX="7" refY="4" orient="auto">
        <path d="M0,0 L8,4 L0,8 z" fill="#6b7280"/>
      </marker>
    </defs>
    <rect x="10" y="14" width="118" height="52" rx="8" fill="#eff6ff" stroke="#3182f6" stroke-width="1.5"/>
    <text x="69" y="36" text-anchor="middle" font-size="12.5" font-weight="bold" fill="#1f2937" font-family="sans-serif">1. 가설</text>
    <text x="69" y="54" text-anchor="middle" font-size="12.5" fill="#1f2937" font-family="sans-serif">수립</text>
    <line x1="128" y1="40" x2="152" y2="40" stroke="#6b7280" stroke-width="1.3" marker-end="url(#arrow-steps)"/>
    <rect x="156" y="14" width="118" height="52" rx="8" fill="#eff6ff" stroke="#3182f6" stroke-width="1.5"/>
    <text x="215" y="36" text-anchor="middle" font-size="12.5" font-weight="bold" fill="#1f2937" font-family="sans-serif">2. 지표</text>
    <text x="215" y="54" text-anchor="middle" font-size="12.5" fill="#1f2937" font-family="sans-serif">선정</text>
    <line x1="274" y1="40" x2="298" y2="40" stroke="#6b7280" stroke-width="1.3" marker-end="url(#arrow-steps)"/>
    <rect x="302" y="14" width="118" height="52" rx="8" fill="#eff6ff" stroke="#3182f6" stroke-width="1.5"/>
    <text x="361" y="36" text-anchor="middle" font-size="12.5" font-weight="bold" fill="#1f2937" font-family="sans-serif">3. 표본 크기</text>
    <text x="361" y="54" text-anchor="middle" font-size="12.5" fill="#1f2937" font-family="sans-serif">결정</text>
    <line x1="420" y1="40" x2="444" y2="40" stroke="#6b7280" stroke-width="1.3" marker-end="url(#arrow-steps)"/>
    <rect x="448" y="14" width="118" height="52" rx="8" fill="#eff6ff" stroke="#3182f6" stroke-width="1.5"/>
    <text x="507" y="36" text-anchor="middle" font-size="12.5" font-weight="bold" fill="#1f2937" font-family="sans-serif">4. 배정</text>
    <text x="507" y="54" text-anchor="middle" font-size="12.5" fill="#1f2937" font-family="sans-serif">방법</text>
    <line x1="566" y1="40" x2="590" y2="40" stroke="#6b7280" stroke-width="1.3" marker-end="url(#arrow-steps)"/>
    <rect x="594" y="14" width="118" height="52" rx="8" fill="#eff6ff" stroke="#3182f6" stroke-width="1.5"/>
    <text x="653" y="36" text-anchor="middle" font-size="12.5" font-weight="bold" fill="#1f2937" font-family="sans-serif">5. 기간</text>
    <text x="653" y="54" text-anchor="middle" font-size="12.5" fill="#1f2937" font-family="sans-serif">결정</text>
  </svg>
</div>
<p align="center" style="color: #888; font-size: 13px;"><em>A/B 테스트 실험 설계 5단계</em></p>
