...
|------|----------------------|-------------------|
| <strong>모수 $\theta$의 본질</strong> | 고정된 미지의 상수 | 불확실성을 가진 확률변수 |
...
| <strong>"이 구간에 $\theta$가 있을 확률이 95%"</strong> | <strong>아니오</strong> (빈도주의에서 $\theta$는 상수) | <strong>예</strong> (베이지안에서 $\theta$는 확률변수) |
