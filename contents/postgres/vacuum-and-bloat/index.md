...
[MVCC 글](/postgres/mvcc-visibility/)에서 xid가 32비트이고, modular arithmetic으로 "과거 21억 / 미래 21억"을 구분한다고 했습니다. 여기서는 VACUUM 관점에서 freeze 파라미터와 운영 모니터링에 집중합니다. xid가 계속 소비되어 한 바퀴를 돌면, 과거에 committed된 xid가 갑자기 "미래"로 뒤집히면서 해당 트랜잭션이 만든 모든 튜플이 안 보이게 됩니다. 이게 **wraparound**이고, 사실상의 데이터 유실입니다.
