...
이번에는 국경을 넘는 게 아무것도 없습니다. 미국 데이터센터에서 돌아가는 서비스에 누가 접속하느냐를 통제한 것입니다. 이는 AI 모델을 **반도체에 준하는 전략 자산**으로 취급하기 시작했다는 신호로 읽힙니다. 칩처럼, 이제 모델도 "누구에게 제공할 수 있는가"가 국가안보 사안이 된 것이죠.
